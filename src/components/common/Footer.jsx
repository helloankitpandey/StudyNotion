      ...
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-14 text-sm">
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              <span> Made with ❤️ </span>
               {" "}
              <Link to='https://github.com/helloankitpandey/' target="__blank" className="text-white hover:underline mr-1"
              >
                Ankit Pandey
              </Link>
            </div>
          ...
          <div className="flex items-center">
            <a href="https://www.linkedin.com/in/helloankit-pandey-/" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://github.com/helloankitpandey/" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
            <a href="https://x.com/heloankitpandey" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImTwitter size={17} />
            </a>
          </div>
